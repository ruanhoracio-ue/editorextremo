...
export default function EdituLogoLoader({
  ...
  const [phase, setPhase] = useState<"drawing" | "filled" | "loop">("drawing");
  ...
  return (
    <div className={`relative flex flex-col items-center justify-center ${className}`}>
      ...
      {/* SVG Logo with Animated Paths */}
      <svg
        viewBox="0 0 500 175"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className={`${sizeClasses[size]} relative z-10 transition-all duration-700 ${
          phase === "filled" || phase === "loop"
            ? "drop-shadow-[0_0_25px_rgba(16,185,129,0.7)]"
      ...
      >
        <defs>
          ...
          <linearGradient id="editu-fill-grad" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <style jsx>{`
          ...
          .looping-shimmer {
            animation: strokeLoop 2.4s ease-in-out infinite;
          }
        ...
        <path
          ...
          fill={phase === "drawing" ? "none" : "url(#editu-fill-grad)"}
          stroke="url(#editu-stroke-grad)"
          strokeWidth="3.5"
          className={`logo-path logo-path-delayed-1 ${phase === "loop" ? "looping-shimmer" : ""}`}
        />
        <path
          ...
          fill={phase === "drawing" ? "none" : "#071B20"}
          stroke="url(#editu-stroke-grad)"
          strokeWidth="2.5"
          className={`logo-path logo-path-delayed-1 ${phase === "loop" ? "looping-shimmer" : ""}`}
        />
        ...
        <path
          ...
          stroke="url(#editu-stroke-grad)"
          strokeWidth="3.5"
          className={`logo-path ${phase === "loop" ? "looping-shimmer" : ""}`}
        />
        <path
        ...
        <path
          ...
          stroke="url(#editu-stroke-grad)"
          strokeWidth="3.5"
          className={`logo-path logo-path-delayed-2 ${phase === "loop" ? "looping-shimmer" : ""}`}
        />
        <path
          ...
          fill={phase === "drawing" ? "none" : "#34d399"}
          stroke="url(#editu-stroke-grad)"
          strokeWidth="3"
          className={`logo-path logo-path-delayed-2 ${phase === "loop" ? "looping-shimmer" : ""}`}
        />
        ...
        <path
          ...
          stroke="url(#editu-stroke-grad)"
          strokeWidth="3.5"
          className={`logo-path logo-path-delayed-3 ${phase === "loop" ? "looping-shimmer" : ""}`}
        />
        ...
        <path
          ...
          stroke="url(#editu-stroke-grad)"
          strokeWidth="3.5"
          className={`logo-path logo-path-delayed-4 ${phase === "loop" ? "looping-shimmer" : ""}`}
        />
      </svg>
      ...
      <div className="mt-6 flex items-center gap-2 font-mono text-xs text-[#a8a8a8]">
        ...
        <span className="text-emerald-400 font-semibold tracking-wider uppercase">
          {phase === "drawing" ? "Desenhando Editu..." : "Carregando plataforma..."}
        </span>
      </div>
    </div>
  );
